...
export const citiesWeather =[
    ...
    {name:"Cairo", springN:18, springM:30, summerN:23, summerM:35, winterN:10, winterM:25, autumnN:20, autumnM:30, visitFrom:"December",visitTo:"January"},
    ...
    {name:"Sharm Elsheik", springN:21, springM:30, summerN:29, summerM:38, winterN:16, winterM:24, autumnN:20, autumnM:28, visitFrom:"October",visitTo:"November"},
]